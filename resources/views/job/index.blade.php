                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ route('job.index') }}/{{$recruitment->id}}" class="btn btn-outline-primary btn-sm m-1">نمایش</a>
                            <a href="{{ route('job.index') }}/{{$recruitment->id}}/edit" class="btn btn-outline-primary btn-sm m-1">ویرایش</a>
                            <form action="{{ route('job.index') }}/{{$recruitment->id}}" method="POST" class="mt-3">
                                @method('delete')
                                @csrf
