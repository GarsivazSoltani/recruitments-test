...
@section('content')
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg mt-5 mb-5">
        <div class="col-lg-12 p-3 p-lg-5 pt-lg-3">
            ...
            <form class="needs-validation" method="POST" action="{{ route('recruitment.index') }}/{{$recruitment->id}}">
                @method('put')
                @csrf
                <div class="row g-3">
                    <div class="col-sm-6">
                        <label for="testName" class="form-label">@lang('public.recruitments name')</label>
                        <input type="text" class="form-control" id="testName" name="testName" value="{{$recruitment->title}}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="experience" name="experience" value="{{$recruitment->total}}" min="1" max="99999">
                        <div class="invalid-feedback">
                ...
                <button class="btn btn-primary btn-lg mt-3" id="btnRegister" type="submit">ویرایش آزمون</button>
            </form>
        </div>
    </div>
